...
public class HealerAbilityItem extends CustomItemFairy {
    ...
    class HealerAbilityListener extends ItemListenerTemplate {
        ...
        public HealerAbilityListener(HealerAbilityItem customItem, PlayerKitManager kitManager, RemoveCustomItem removeCustomItem, HealerAbilityItem healerAbilityItem, GameStateManager gameStateManager) {
            super(customItem);
